...
class BeritaController extends Controller
{
    ...
    {
        return view('berita.berita', ['posts' => $this->getNewsItems()]);
    }

    public function showNews($slug)
    {
        $newsItems = $this->getNewsItems();
        $news = collect($newsItems)->first(function ($item) use ($slug) {
        ...
        // Add dummy content
        $news['author'] = 'Admin Inspektorat';
        $news['content'] = '<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            ...
                            <h3 class="text-xl font-bold text-slate-900 mt-6 mb-3">Poin Penting Audit</h3>
                            <ul class="list-disc pl-5 mb-4 space-y-2">
                                <li>Peningkatan transparansi anggaran daerah.</li>
                                <li>Evaluasi kinerja setiap SKPD secara berkala.</li>
                                <li>Implementasi sistem pengawasan berbasis risiko.</li>
                            </ul>
                            <p>Semoga dengan adanya kegiatan ini, tata kelola pemerintahan di Kabupaten Mahakam Ulu semakin baik dan akuntabel.</p>';

        // Filter related news: Same category, exclude current, max 5
        $relatedNews = collect($newsItems)
    ...
    {
        return view('berita.informasi-lainnya');
    }
}
