...
<section class="relative bg-white py-12 lg:py-16 overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-6xl mx-auto">
            ...
            <!-- Search Bar Section -->
            <div class="mb-6 md:mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-6">
                <div class="flex items-center gap-2 md:gap-3">
                    <div class="w-1 md:w-1.5 h-6 md:h-8 bg-emerald-500 rounded-full"></div>
                    <h3 class="font-black text-slate-800 text-base md:text-lg uppercase tracking-tight">Cari Regulasi</h3>
                </div>
            ...
            <div id="documentContainer" class="space-y-6">
                ...
                <div class="document-card relative bg-white rounded-[2rem] shadow-[0_15px_40px_-12px_rgba(0,0,0,0.06)] border border-gray-100 overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
                    ...
                    <div class="flex flex-col lg:flex-row p-4 md:p-6 lg:p-8 ml-2 gap-4 lg:gap-10 items-center">
                        ...
                        <div class="flex-grow text-center lg:text-left title-container">
                            ...
                            <h3 class="document-title text-base md:text-lg lg:text-xl font-black text-slate-900 font-montserrat leading-tight mb-3 md:mb-4 group-hover:text-emerald-700 transition-colors">
                                {{ $item['name'] }}
                            </h3>
                        ...
                        <!-- Right: Actions -->
                        <div class="flex flex-row lg:flex-col gap-2 md:gap-3 flex-shrink-0 w-full lg:w-40 pt-3 md:pt-4 lg:pt-0 border-t lg:border-t-0 lg:border-l border-gray-100 lg:pl-10">
                            <a href="{{ $item['file_url'] ?? '#' }}" download target="_blank" class="flex-1 lg:flex-none inline-flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 md:py-3.5 bg-emerald-600 text-white text-[10px] md:text-[11px] font-black uppercase tracking-wider md:tracking-widest rounded-xl md:rounded-2xl hover:bg-emerald-700 hover:shadow-xl hover:shadow-emerald-500/25 transition-all transform hover:-translate-y-0.5">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                                Unduh
                            </a>
                            <button type="button" onclick="openPdfModal('{{ $item['file_url'] ?? '#' }}')" class="flex-1 lg:flex-none inline-flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 md:py-3.5 bg-slate-50 text-slate-600 text-[10px] md:text-[11px] font-black uppercase tracking-wider md:tracking-widest rounded-xl md:rounded-2xl border border-slate-200 hover:bg-white hover:text-emerald-600 hover:border-emerald-500 hover:shadow-lg transition-all transform hover:-translate-y-0.5">
                                Lihat
                            </button>
                        </div>
                    </div>
