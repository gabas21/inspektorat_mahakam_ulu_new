...
@section('title', 'Tugas & Fungsi - Inspektorat Kabupaten Mahakam Ulu')
    ...
    <div class="container mx-auto px-6 relative z-10 py-32">
        ...
        <div class="text-center mb-16 reveal">
            ...
            <h2 class="text-4xl md:text-6xl font-black text-white px-2 font-montserrat uppercase tracking-tight leading-[1.1] mb-4">
                Tugas Pokok & <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">Fungsi</span>
            </h2>
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div class="reveal group">
                <div class="relative bg-white/10 backdrop-blur-xl rounded-[2rem] p-8 md:p-10 border border-white/20 hover:border-emerald-400/40 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10 overflow-hidden h-full flex flex-col">
                    ...
                    <div class="flex-1 flex items-center">
                        <p class="text-white/90 text-base md:text-lg leading-relaxed font-inter text-center italic">
            ...
            <div class="reveal group" style="animation-delay: 0.2s;">
                <div class="relative bg-white/10 backdrop-blur-xl rounded-[2rem] p-8 md:p-10 border border-white/20 hover:border-emerald-400/40 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10 overflow-hidden h-full">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-3 p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-emerald-400/30 transition-all duration-300 group/item">
                            <div class="flex-shrink-0 w-7 h-7 bg-emerald-500/20 text-emerald-400 rounded-lg flex items-center justify-center font-bold text-xs group-hover/item:bg-emerald-500 group-hover/item:text-white transition-all">
                                {{ $index + 1 }}
                            </div>
                            <p class="text-white/80 text-sm font-inter leading-relaxed group-hover/item:text-white/95 transition-colors">
                                {{ $fungsi }}
                            </p>
                        </div>
                        @endforeach
