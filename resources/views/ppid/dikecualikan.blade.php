...
@section('title', 'Informasi Dikecualikan - Inspektorat Kabupaten Mahakam Ulu')
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4 pt-16">
        <div class="relative z-10">
            ...
            <h2 class="text-3xl md:text-5xl font-black text-white px-2 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] font-montserrat uppercase tracking-tight leading-[1.1]">
                Informasi <span class="text-emerald-400">Dikecualikan</span>
            </h2>
        </div>
    </div>
</section>
...
<!-- Content Section -->
<section id="main-content-section" class="relative bg-white py-12 lg:py-16 overflow-hidden min-h-screen">
