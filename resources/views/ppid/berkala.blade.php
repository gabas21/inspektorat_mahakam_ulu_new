...
@section('title', 'Informasi Berkala - Inspektorat Kabupaten Mahakam Ulu')
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4 pt-32">
        <div class="relative z-10">
            ...
            <h2 class="text-3xl md:text-5xl font-black text-white px-2 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] font-montserrat uppercase tracking-tight leading-[1.1]">
                Informasi <span class="text-emerald-400">Berkala</span>
            </h2>
        </div>
    </div>
</section>
...
<!-- Content Section -->
<section id="main-content-section" class="relative bg-white py-16 lg:py-24 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto space-y-4" x-data="{ active: null }">
            ...
            <div class="mb-8 text-center max-w-2xl mx-auto">
                <p class="text-slate-600 text-sm leading-relaxed">
                    Informasi yang wajib disediakan dan diumumkan secara berkala oleh Badan Publik paling singkat 6 (enam) bulan sekali.
                </p>
            </div>
